...
"The primary goal of the VST Photometric Ha Survey of the Southern Galactic Plane and Bulge (VPHAS+) is to collect single-epoch ugri broad-band and Ha narrow-band photometry across the southern Galactic Plane within the latitude range -5o< b < +5odown to point source magnitudes of ~21 or better.  The VPHAS+ footprint also includes the inner Galactic Bulge, defined as a 20 x 20 deg2box around the Galactic Centre: this assures optical coverage of the full VVV footprint" (Info taken from https://www.vphasplus.org/vphasplus-dr3-release-description.pdf).
